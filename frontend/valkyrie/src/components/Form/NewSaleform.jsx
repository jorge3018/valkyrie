...
export default function NewSaleform(props) {
    ...
    const handleSave = (event) => {
        props.onSave(sale, description, value, quantity, unitValue, date, document, client, seller, stateSale);
    ...
    const handleSubmit = (e) => {
        ...
        if(description !==null && value !==0 && sale !==null){
          setSend(true);
        }
        setValidated(true); 
...
<Modal show={props.show} onClose={handleClose}>
       <Modal.Header>
        ...
        <Modal.Body>
            <Form noValidate validated={validated} onClick={e => setValue(quantity*unitValue)} > 
                <Row className="mb-1">
                ...
                <Row className="mb-1">
                    <Form.Group as={Col} md="12" controlId="validationCustom07">
                    <Form.Label>Valor Total: <Form.Control
                className="form-control"
                placeholder={value}
                name="value"
                type="number"
